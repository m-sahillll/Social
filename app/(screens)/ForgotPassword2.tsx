...
const ForgotPassword2 = () => {
  ...
  return (
    <View style={{ paddingHorizontal: 20 }}>
      ...
      <Text style={{color: AppColor.BUTTON,marginTop:10,fontWeight:'bold'}}>Can't reset your password?</Text>
      </TouchableOpacity>
      <InputBox 
      keyboardType="phone-pad"
      placeholder="Mobile number"/>
      <Text style={{marginTop:10,opacity:0.6,}}>You may recieve WhatsApp and SMS notifications from us for security and login purposes.</Text>
      <CustomButton 
      style={{marginTop :20}}
